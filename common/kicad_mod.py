...
class KicadMod(object):
    ...
    def _new_text (self, which_text, text_value):
        text_dict = {}
        text_dict[which_text] = text_value
        text_dict['pos'] = {'x':0, 'y':0, 'orientation':0}
        # text layer
        text_dict['layer'] = 'Front'
        # text font
        text_dict['font'] = {'thickness': 0.15, 'height': 1.5, 'width': 1.5}
        return text_dict
